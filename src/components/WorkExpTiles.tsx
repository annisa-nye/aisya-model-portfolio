      ...
      >
        {expIds.map((expId, index) => (
          <motion.div
            key={expId}
            id={expId}
            className={`work-exp-tile relative mx-2 inline-block h-[25em] w-[20em] bg-[url('./assets/images/p2-pink-blue/p2-2.jpeg')] bg-cover bg-fixed bg-top bg-no-repeat xs:w-[14em] sm:w-[16em] ${index === 0 ? "mt-[-5em]" : ""} ${index === 1 ? "mt-0" : ""} ${index === 2 ? "mb-[-5em]" : ""}`}
