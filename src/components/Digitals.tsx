...
const PortfolioCard: React.FC<PortfolioItem> = ({ title, folderName }) => {
	...
	const images = [1, 2, 3, 4, 5]; // Assuming each folder has at least 5 images
	...
	return (
		<div className='bg-white rounded-lg shadow-md overflow-hidden h-full flex flex-col'>
			...
			<div className='relative flex-grow'>
				<img
					src={`src/assets/images/${folderName}/${folderName}-${images[currentImage]}.jpeg`}
...
const PortfolioGallery: React.FC = () => {
	const portfolioItems: PortfolioItem[] = [
		{ title: 'Digitals', folderName: 'p0-digitals' },
